                  ...
                  Row(
                    ...
                    children: <Widget>[
                      FloatingActionButton(
                        elevation: 0,
                        onPressed: () {
                          launch('https://github.com/Godfather0484');
                        },
                      ...
                      FloatingActionButton(
                        ...
                        onPressed: () {
                          launch(
                              'https://www.linkedin.com/in/jitin-bhardwaj-a12109231/');
                        },
                        backgroundColor: inActiveColor,
                      ...
                      FloatingActionButton(
                        elevation: 0,
                        onPressed: () {
                          launch('https://twitter.com/JitinBhardwaj12');
                        },
                        backgroundColor: inActiveColor,
                        child: const Icon(FontAwesomeIcons.twitterSquare,
                            color: Colors.white),
                      ),
                    ],
                  ),
